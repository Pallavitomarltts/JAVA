	...
	public class PlayercomparatorMainans1 {

		public static void main(String[] args) throws Exception {
		Scanner sc=new Scanner(System.in);
		ArrayList<Playerans1> l=new ArrayList<Playerans1>();
		 InputStreamReader r=new InputStreamReader(System.in);    
		    BufferedReader br=new BufferedReader(r);   
		    Playerans1 p=new Playerans1();
	    ...
	    for(int i=0;i<no;i++)
	    {
	    	...
	    	l.add(new Playerans1(name,skill1));
  	
	    }
	    Collections.sort(l,new Playercomparatorans1());
